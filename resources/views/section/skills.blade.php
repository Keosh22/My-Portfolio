<section class="max-container w-full flex lg:flex-row flex-col gap-12 justify-around items-center my-10">
  ...
  <div class="flex flex-col justify-start items-start">
    ...
    <div class="flex flex-wrap justify-start gap-5 mt-3">
      <img class="h-12 w-12" src="{{asset("images/Html-5.png")}}" alt="html-icon">
      <img class="h-12 w-12" src="{{asset("images/CSs.png")}}" alt="css-icon">
      <img class="h-12 w-12" src="{{asset("images/JavaScript.png")}}" alt="javascript-icon">
      <img class="h-12 w-12" src="{{asset("images/laravel_icon.png")}}" alt="laravel-icon">
      <img class="h-12 w-12" src="{{asset("images/mysql_logo.png")}}" alt="mysql-icon">
      <img class="h-12 w-12" src="{{asset("images/Tailwind.png")}}" alt="tailwind-icon">
      <img class="h-12 w-12" src="{{asset("images/git_icon.png")}}" alt="git-icon">
    </div>
  </div>
</section>